    ...
    <div className="container flex flex-col items-center justify-center gap-4 py-20 md:py-32">
      ...
      >
        ...
        >
          ...
          using React, Next.js, Node.js, Express.js, Python, Flask, Django, PostgreSQL,
      ...
      >
        <Link href="https://github.com/Riteshpatil077" target="_blank" rel="noopener noreferrer">
          <Button variant="ghost" size="icon" className="rounded-full">
            <Github className="h-5 w-5" />
            <span className="sr-only">GitHub</span>
          </Button>
        </Link>
        <Link href="https://linkedin.com/in/ritesh-patil-4197b9297" target="_blank" rel="noopener noreferrer">
          <Button variant="ghost" size="icon" className="rounded-full">
            <Linkedin className="h-5 w-5" />
            <span className="sr-only">LinkedIn</span>
          </Button>
        </Link>
        <Link href="mailto:patilritesh7172@gmail.com">
          <Button variant="ghost" size="icon" className="rounded-full">
